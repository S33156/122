    ...
    if results.multi_hand_landmarks:
        for hand_landmark in results.multi_hand_landmarks:
            ...
            for tip in finger_tips:
                ...
                # i.e., checking if finger tip starting value is smaller than finger starting position which is inner landmark for the index finger
            ...
            if all(finger_fold_status):
                # Simulate a mouse click when all fingers are folded
                pyautogui.click()
